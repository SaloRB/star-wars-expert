...
| -------- | ----------------------------- | --------------- |
| **Lint** | Ruff linter + formatter check | ~30s            |
...
### 7.1 Runbook: Rebuild Vector Store
...
### 7.3 Runbook: OpenAI Quota Exceeded
...
### 7.4 Runbook: Error de Conexión a IMSDB
...
### 7.5 Runbook: Actualizar Dependencias
...
### 10.1 Métricas Técnicas (Observables)
