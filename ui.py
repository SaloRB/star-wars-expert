...
def create_step_display(steps: list[tuple[str, str]], spinner_frame: int = 0, title: str = "Progress") -> Panel:
...
class StepProgress:
    ...
    def __init__(self, console: Console, steps: list[str], title: str = "🚀 Initializing Star Wars Expert"):
